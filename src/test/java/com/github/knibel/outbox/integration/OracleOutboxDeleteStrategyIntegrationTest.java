...
/**
 * Integration test verifying the {@code DELETE} acknowledgement strategy on Oracle.
 *
 * <ol>
...
@SpringBootTest(
        ...
        properties = {
                ...
                "outbox.tables[0].staticTopic=oracle-delete-topic",
...
@Testcontainers
class OracleOutboxDeleteStrategyIntegrationTest {
    ...
    static void createKafkaTopic() throws Exception {
        ...
        try (AdminClient admin = AdminClient.create(adminProps)) {
            admin.createTopics(List.of(new NewTopic("oracle-delete-topic", 1, (short) 1)))
                    .all()
    ...
    private static KafkaConsumer<String, String> createConsumer(String bootstrapServers) {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "oracle-delete-test-consumer-" + UUID.randomUUID());
