...
@SpringBootTest(
        ...
        properties = {
                ...
                "outbox.tables[0].mappings[0].source=entity_id",
                "outbox.tables[0].mappings[0].target=eventData.entityId",
                "outbox.tables[0].mappings[0].dataType=LONG",
                "outbox.tables[0].mappings[1].source=reference_date",
                "outbox.tables[0].mappings[1].target=eventData.items.referenceDate",
                "outbox.tables[0].mappings[1].dataType=DATE",
                "outbox.tables[0].mappings[1].format=yyyy-MM-dd",
                "outbox.tables[0].mappings[2].source=batch_ref_id",
                "outbox.tables[0].mappings[2].target=eventData.items.batchId",
                "outbox.tables[0].mappings[2].dataType=LONG",
                "outbox.tables[0].mappings[3].source=default_flag",
                "outbox.tables[0].mappings[3].target=eventData.items.defaultFlag",
                "outbox.tables[0].mappings[3].dataType=BOOLEAN",
                "outbox.tables[0].mappings[4].source=duplicate_flag",
                "outbox.tables[0].mappings[4].target=eventData.items.duplicateFlag",
                "outbox.tables[0].mappings[4].dataType=BOOLEAN",
                "outbox.tables[0].mappings[5].source=amount",
                "outbox.tables[0].mappings[5].target=eventData.items.amount",
                "outbox.tables[0].mappings[5].dataType=DECIMAL",
                "outbox.tables[0].mappings[6].source=liability_amount",
                "outbox.tables[0].mappings[6].target=eventData.items.liabilityAmount",
                "outbox.tables[0].mappings[6].dataType=DECIMAL",
                "outbox.tables[0].mappings[7].source=liability_ts",
                "outbox.tables[0].mappings[7].target=eventData.items.liabilityTs",
                "outbox.tables[0].mappings[7].dataType=DATETIME",
                "outbox.tables[0].mappings[7].format=yyyy-MM-dd'T'HH:mm:ss",
                "outbox.tables[0].mappings[8].target=eventType",
                "outbox.tables[0].mappings[8].value=DataRequest.ItemsRequested",
                "outbox.tables[0].mappings[9].target=eventData.companyId",
                "outbox.tables[0].mappings[9].value=1",
                ...
                "outbox.tables[1].mappings[0].source=record_count",
                "outbox.tables[1].mappings[0].target=eventData.recordCount",
                "outbox.tables[1].mappings[0].dataType=LONG",
                "outbox.tables[1].mappings[1].source=reference_date",
                "outbox.tables[1].mappings[1].target=eventData.referenceDate",
                "outbox.tables[1].mappings[1].dataType=DATE",
                "outbox.tables[1].mappings[1].format=yyyy-MM-dd",
                "outbox.tables[1].mappings[2].source=batch_id",
                "outbox.tables[1].mappings[2].target=eventData.batchId",
                "outbox.tables[1].mappings[2].dataType=LONG",
                "outbox.tables[1].mappings[3].target=eventType",
                "outbox.tables[1].mappings[3].value=BatchStatus.BatchInfoProvided",
